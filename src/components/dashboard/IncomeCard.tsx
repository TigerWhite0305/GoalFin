    ...
    <div className={`h-full flex flex-col ${isDarkMode ? 'bg-gradient-to-br from-slate-800 via-emerald-900 to-emerald-800' : 'bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-600'} rounded-2xl p-4 justify-between shadow-xl border ${isDarkMode ? 'border-emerald-800/30' : 'border-emerald-400/30'} hover:shadow-2xl transition-all duration-300`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-base md:text-lg font-semibold text-white">Entrate</h2>
        </div>
      ...
      <div className="flex flex-col gap-2 my-3">
        <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-white tracking-tight">
          ...
          <span className="text-base md:text-lg text-emerald-200">€</span>
        </p>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1 px-2.5 py-1 rounded-xl bg-emerald-400/90 text-emerald-900 font-semibold backdrop-blur-sm border border-emerald-300/30 shadow-lg">
