// src/components/statistics/ExpenseChart.tsx
...
const ExpenseChart = forwardRef<HTMLDivElement, ExpenseChartProps>(({
  ...
  return (
    <div className="xl:col-span-2 bg-gradient-to-br from-gray-800 via-gray-800 to-gray-900 p-6 rounded-3xl shadow-2xl border border-gray-700/50" ref={ref}>
